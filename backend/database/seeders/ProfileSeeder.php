...
class ProfileSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $user = User::role('admin')->first() ?? User::firstOrCreate(
            ...
            ['name' => config('portfolio.admin_name', 'ASMARE Admin'), 'password' => config('portfolio.admin_password', 'change-me-now')]
        );
        ...
        $posts = [
            [
                ...
                'excerpt' => 'What I learned evaluating satellite precipitation products against ground data in the Belles Basin.',
                'body' => 'In this article I walk through the workflow I use to bias-correct and evaluate satellite rainfall products (CHIRPS, ERA5) against gauged observations, and how that feeds reliable SWAT+ streamflow simulation in data-scarce basins.',
                'tags' => [['name' => 'Hydrology'], ['name' => 'SWAT+'], ['name' => 'Remote Sensing']],
            ...
            [
                ...
                'body' => 'From the IWMI/CGIAR training to applied basin studies — here is how coupled SWAT-MODFLOW modelling helps identify zones for managed aquifer recharge and sustainable storage strategies.',
                'tags' => [['name' => 'Groundwater'], ['name' => 'SWAT-MODFLOW']],
            ...
            [
                ...
                'body' => 'Python has become an essential tool in my hydrology workflow. Here I share the scripts and patterns I use for missing-data treatment, consistency checks, trend analysis and automated reporting.',
                'tags' => [['name' => 'Python'], ['name' => 'Data Analysis']],
    ...
    /**
     * Real CV data (source: Asmare Belay Ngussie CV, verified 2026-09-23).
     *
    ...
    public static function cvData(): array
    {
        return [
            'profile' => [
                ...
                'tagline' => 'Advancing sustainable water resources solutions and climate resilience through hydrological modeling, integrated water management, and geospatial analysis.',
                ...
                'twitter' => null,
                'whatsapp' => null,
                'roles' => ['Hydrology & Water Resources Engineer', 'Lecturer & Researcher', 'Hydrological Modeler', 'GIS & Remote Sensing Specialist'],
            ...
            'experiences' => [
                [
                    ...
                    'end_date' => null,
                    'current' => true,
                    'description' => 'Department of Water Resources and Irrigation Engineering — teaching undergraduate students and supporting postgraduate students in water resources and irrigation engineering, civil and hydraulics engineering, including hydrology, groundwater, hydraulics, irrigation, drainage, climate change, GIS, and remote sensing.',
                    'highlights' => [
                ...
                [
                    ...
                    'end_date' => '2020-05-04',
                    'current' => false,
                    'description' => 'Collected, organized, and managed hydro-meteorological data including rainfall, temperature, streamflow, groundwater levels, evaporation, and soil moisture from field stations, gauging sites, and secondary data sources.',
                    'highlights' => [
                ...
                [
                    ...
                    'end_date' => '2017-10-03',
                    'current' => false,
                    'description' => 'Taught undergraduate courses related to water resources and irrigation engineering, including hydrology, hydraulics, groundwater, irrigation systems design, water management, GIS, and remote sensing.',
                    'highlights' => [
            ...
            'publications' => [
                [
                    'title' => 'Evaluating Streamflow Performance Using Satellite Rainfall Products and SWAT+ Modeling in Belles Basin, Ethiopia',
                    'authors' => 'Asmare Belay Ngussie',
                    'venue' => 'Bahir Dar Institute of Technology, Bahir Dar University',
                    'type' => 'thesis',
                    'year' => '2020',
                    'abstract' => 'MSc thesis evaluating the streamflow simulation performance of satellite rainfall products coupled with SWAT+ modeling in the Belles Basin, Ethiopia — providing a basis for reliable hydrological prediction in data-scarce basins.',
